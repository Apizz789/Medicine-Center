...
//        System.out.println(API.getCustom("Comments"));
    ...
    public static void InitDrugInform() {
        ...
        db.setFile("Drugs");
        Drug d1 = new Drug("ยาเเก้ปวดท้อง", "ยาธาตุน้ำขาวกระต่ายบิน", "ทำลายเชื้อโรคในลำไส้ รักษาอาการอักเสบของลำไส้ แก้ปวดท้อง", "20/12/20", "200", "100");
      Drug d2 = new Drug("ยาฆ่าเชื้อ", "Amoxicillin", "ยาปฏิชีวนะกลุ่มเพนิซิลลิน (Penicillins) ซึ่งจะใช้ในการรักษาโรคที่มีสาเหตุการติดเชื้อมาจากแบคทีเรีย ", "16/2/24", "200", "45");
       Drug d3 = new Drug("ยาแก้ปวด", "paracetamol", "มีฤทธิ์ยับยั้งการสร้างโพรสตาแกลนดิน (Prostaglandin) ในสมอง แบบเดียวกับยาต้านการอักเสบที่ไม่ใช่สเตียรอยด์ (NSAIDs)", "28/3/26", "250", "30");
       Drug d4 = new Drug("ยาดมเเละยาทา", "ยาดมโป้ยเซียน", "ใช้ดม ใช้ทา ในหลอดเดียวกัน", "20/2/30", "15", "45");
        arr.add(d1);
       arr.add(d2);
        arr.add(d4);
        arr.add(d3);
